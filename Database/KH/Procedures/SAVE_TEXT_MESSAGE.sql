...
BEGIN
    ...
    BEGIN
    INSERT INTO MESSAGE(ID_SENDER,ID_RECEIPT,REG_DATE,READ_STATE,CONTENT_TYPE,UID,ID_REPLY,TIMEID)
    VALUES(:ID_SENDER_TOKEN,:ID_RECEIPT_TOKEN,:REG_DATE,:IS_READ,:CONTENT_TYPE,:UID,:ID_REPLY,:TIMEID)
    RETURNING ID
    INTO :ID_MESSAGE;
    END
    ELSE 
    BEGIN --Save message header for file messages
      ...
      INSERT INTO MESSAGE(ID_SENDER,ID_RECEIPT,REG_DATE,READ_STATE,CONTENT_TYPE,UID,ID_REPLY,STATE,TIMEID)
	  VALUES(:ID_SENDER_TOKEN,:ID_RECEIPT_TOKEN,:REG_DATE,:IS_READ,:CONTENT_TYPE,:UID,:ID_REPLY,-1,:TIMEID)
      RETURNING ID
	  INTO :ID_MESSAGE;
    END
