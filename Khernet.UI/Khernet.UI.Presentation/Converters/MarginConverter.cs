...
{
    /// <summary>
    /// Converts a boolean value of fullscreen to <see cref="Thickness"/> object
    /// </summary>
    ...
    /// <summary>
    /// Converts fullscrenn mode to <see cref="VerticalAlignment.Stretch"/> when true or <see cref="VerticalAlignment.Center"/> when false
    /// </summary>
