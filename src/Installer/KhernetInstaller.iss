...
#define CurrentVersion "0.23.0.0"
...
Source: "..\..\bin\{#ApplicationName}.exe"; Check:FileExists(ExpandConstant('{app}\{#AppDirectoryName}\app\{#ApplicationName}.exe')); DestDir: "{app}\{#AppDirectoryName}\app"; AfterInstall:RemoveFile(ExpandConstant('{app}\{#AppDirectoryName}\app\{#ApplicationName}.exe'));

; Install the new main executable.
Source: "..\..\bin\{#ApplicationName}.exe"; DestDir: "{app}"; AfterInstall:DeployFileSystem(ExpandConstant('{app}\{#AppDirectoryName}'));
