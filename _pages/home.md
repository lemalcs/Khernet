...
<div style="border-bottom: 1px solid #f2f3f3">
  <div style="display:inline-block;min-height: 400px;padding:20px;padding-top:150px;padding-bottom:200px;vertical-align:middle">
    ...
    <a class="btn btn--info"
      href="https://github.com/lemalcs/Khernet/releases/download/v0.23.0.0/KhernetInstaller-0.23.0.0.exe">
      Download for Windows
    </a>
    <br/>
    <br/>
    <a href="https://github.com/lemalcs/Khernet/releases/download/v0.23.0.0/Khernet.exe" class="btn">Get portable application</a>
  </div>
